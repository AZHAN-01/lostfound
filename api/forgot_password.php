...
function send_real_email($to, $otp) {
    ...
    try {
        ...
        $mail->Body    = "<h3>Password Reset Code</h3><p>Your 4-digit code to reset your password is: <strong style='font-size: 1.2rem;'>" . $otp . "</strong></p><p>This code is valid for 5 minutes.</p>";
        $mail->AltBody = "Your 4-digit code to reset your password is: " . $otp . "\nThis code is valid for 5 minutes.";
