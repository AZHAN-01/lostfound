...
function send_brevo_email($to, $otp) {
    ...
    $payload = json_encode([
        "sender" => [
            ...
            "email" => getenv('SMTP_USER') ?: "noreply@lostfound.com"
        ],
        "to" => [
            [
                "email" => $to
        ...
        "htmlContent" => "<h3>Password Reset Code</h3><p>Your 4-digit code to reset your password is: <strong style='font-size: 1.2rem;'>" . $otp . "</strong></p><p>This code is valid for 5 minutes.</p>"
    ]);
